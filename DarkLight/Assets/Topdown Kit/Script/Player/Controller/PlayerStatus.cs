...
public class PlayerStatus : MonoBehaviour {
	...
	public Attribute status;  //main status主属性
	public SubAttribute statusAdd; //add status(from equip,skill)次级属性
	public SumAttribute statusCal; //summary status总和
	public SumEquip statusEquip;
	public StatusGrowth statusGrowth,growthSetting; //status growth when level up升级加成
	
	public float hpRegenTime; //hp regen per second  HPMP回复
	...
	void Start () {
            //初始化最大经验值，人物的成长值，属性，MaxHP，MaxMP，调用了自动恢复HPMP的方法
